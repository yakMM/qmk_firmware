...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_all(
            ...
            KC_LCTL,    KC_LGUI,    KC_LALT,    KC_F14,         KC_F13,             KC_SPC,             KC_RALT,                KC_RCTL,                KC_LEFT,    KC_DOWN,    KC_RGHT)
};

const uint16_t PROGMEM insert_combo[] = {KC_HOME, KC_END, COMBO_END};
const uint16_t PROGMEM calc_combo[] = {KC_GRV, KC_1, COMBO_END};
combo_t key_combos[] = {
    COMBO(insert_combo, KC_INSERT),
    COMBO(calc_combo, KC_CALC)
};
